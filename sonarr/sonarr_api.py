...
"""
From: https://github.com/SLiX69/Sonarr-API-Python-Wrapper

Modified to add TLS client certificate support
"""
...
class SonarrAPI(object):
    ...
    def __init__(self, host_url, api_key, client_cert=None):
    ...
    def request_get(self, url, data={}):
        ...
        res = requests.get(url, headers=headers, json=data, cert=self.client_cert)
        return res
    ...
    def request_post(self, url, data):
        ...
        res = requests.post(url, headers=headers, json=data, cert=self.client_cert)
        return res
    ...
    def request_put(self, url, data):
        ...
        res = requests.put(url, headers=headers, json=data, cert=self.client_cert)
        return res
    ...
    def request_del(self, url, data):
        ...
        res = requests.delete(url, headers=headers, json=data, cert=self.client_cert)
        return res
